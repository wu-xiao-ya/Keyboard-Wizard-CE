...
Keyboard Wizard CE is the community edition branch of Modern KeyWizard for Minecraft 1.21.6 on Fabric.

- Branch: `ce/fabric-1.21.6`
- Mod id: `keyboard_wizard_ce`
- Mod name: `Keyboard Wizard CE`
- Maven group: `io.github.wu_xiao_ya.keyboard_wizard_ce.fabric`
- Archive base name: `keyboard-wizard-ce-fabric-1.21.6`
- Original authors: MrNerdy42, Tapio
- Art assets: WI_8614_ice
- Target: Minecraft 1.21.6 + Fabric
- Java: 21
...
| --- | --- | --- | --- | --- |
| Fabric | 1.21.6 | 21 | `ce/fabric-1.21.6` | Yarn `1.21.6+build.1` |
