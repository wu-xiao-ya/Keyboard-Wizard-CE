...
Keyboard Wizard CE is the community edition branch of Modern KeyWizard for Minecraft 26.1.1 on Fabric.

- Branch: `ce/fabric-26.1.1`
- Mod id: `keyboard_wizard_ce`
- Mod name: `Keyboard Wizard CE`
- Maven group: `io.github.wu_xiao_ya.keyboard_wizard_ce.fabric`
- Archive base name: `keyboard-wizard-ce-fabric-26.1.1`
- Original authors: MrNerdy42, Tapio
- Art assets: WI_8614_ice
- Target: Minecraft 26.1.1 + Fabric
- Java: 25
...
| --- | --- | --- | --- | --- |
| Fabric | 26.1.1 | 25 | `ce/fabric-26.1.1` | official Mojang mappings |
