...
Community Edition / unofficial port of Modern KeyWizard for Minecraft 1.18.2 on Forge.
...
- Upstream project: Keyboard Wizard
...
- Middle-clicking a key filters the left-side list to bindings assigned to that key.
