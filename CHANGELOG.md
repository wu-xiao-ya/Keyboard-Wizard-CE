...
- Published this branch under release tag `forge-1.20.1-v1.0.2beta`.
...
- Added the vanilla Controls screen bottom-right toggle button through the Forge screen init event.
- Confirmed the CE mod id and metadata use `keyboard_wizard_ce`.
- Latest verified Actions build: `27617673586`.
