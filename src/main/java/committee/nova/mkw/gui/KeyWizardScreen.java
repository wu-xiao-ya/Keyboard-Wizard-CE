...
public class KeyWizardScreen extends GameOptionsScreen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, BACKGROUND_TEXTURE, 0, 0, 0, 0, this.width, this.height, 512, 512);
    ...
    private static class TextureButton extends ButtonWidget {
        ...
        public void renderWidget(DrawContext ctx, int mouseX, int mouseY, float delta) {
            ...
            ctx.drawTexture(RenderLayer::getGuiTextured, ModernKeyWizard.SCREEN_TOGGLE_WIDGETS, this.getX(), this.getY(), 0, textureY, 20, 20, 40, 40);
        }
    }
}
