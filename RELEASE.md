...
- Release jar: `build/libs/keyboard-wizard-ce-forge-1.20.1-1.0.2beta.jar`
- Source jar: `build/libs/keyboard-wizard-ce-forge-1.20.1-1.0.2beta-sources.jar`
- Release bundle: `build/release/keyboard-wizard-ce-forge-1.20.1-1.0.2beta-release.zip`
...
git tag forge-1.20.1-v1.0.2beta
git push origin forge-1.20.1-v1.0.2beta
```
