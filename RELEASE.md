...
- Release jar: `build/libs/keyboard-wizard-ce-forge-1.16.5-1.0.2beta.jar`
- Source jar: `build/libs/keyboard-wizard-ce-forge-1.16.5-1.0.2beta-sources.jar`
- Release bundle: `build/release/keyboard-wizard-ce-forge-1.16.5-1.0.2beta-release.zip`
...
git push -u origin ce/forge-1.16.5
git tag forge-1.16.5-v1.0.2beta
git push origin forge-1.16.5-v1.0.2beta
```
